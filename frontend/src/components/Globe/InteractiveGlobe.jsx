...
export default function InteractiveGlobe({ onBack, isTransitioning, userType = 'personal' }) {
    ...
    const quickActions = userType === 'professional' ? [
        ...
        { id: 'volunteer', label: 'How Can I Help?', icon: '', prompt: 'Find up to 6 nearby volunteering organizations or groups that work on wildfire recovery, reforestation, or environmental restoration in this area or in the state. Include their names, what they do, contact information (phone numbers, websites, emails if available), and how someone can sign up to volunteer with them. Focus on organizations that accept individual volunteers for hands-on restoration work.' },
